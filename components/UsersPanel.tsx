...
export default function UsersPanel({ projectName, isOpen, onClose }: UsersPanelProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-[#333333]">
        <span className="text-[#827989] text-sm font-medium">{users.length} members</span>
        <div className="flex items-center gap-2">
          ...
          <Button variant="ghost" size="sm" onClick={onClose} className="text-[#827989] hover:text-white ml-2">
            <X className="w-4 h-4" />
          </Button>
        </div>
      </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-medium text-[#ffb563]">{user.name}</span>
                  {user.role && <span className="text-xs text-[#827989]">{user.role}</span>}
                </div>
              </div>
              <Button
                variant="ghost"
